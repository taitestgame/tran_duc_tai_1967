...
class Ui_ECCCipher(object):
    def setupUi(self, ECCCipher):
        ...
        ECCCipher.resize(567, 317)
        self.centralwidget = QtWidgets.QWidget(ECCCipher)
        self.centralwidget.setObjectName("centralwidget")
        self.label_title = QtWidgets.QLabel(self.centralwidget)
        self.label_title.setGeometry(QtCore.QRect(100, 10, 160, 30))
        font = QtGui.QFont()
        ...
        self.btn_generate_keys.setGeometry(QtCore.QRect(380, 10, 100, 30))
        ...
        self.txt_information.setGeometry(QtCore.QRect(120, 60, 361, 60))
        ...
        self.txt_signature.setGeometry(QtCore.QRect(120, 140, 361, 60))
        ...
        self.btn_verify.setGeometry(QtCore.QRect(380, 220, 100, 30))
